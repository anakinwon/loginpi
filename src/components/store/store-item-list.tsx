            ...
            >
              ...
              <div className='space-y-1 p-3'>
                ...
                <div className='text-muted-foreground flex items-center gap-2 text-xs'>
                  <span className='bg-muted rounded px-1.5 py-0.5'>{t(`cnd.${item.item_cnd_cd}`)}</span>
                  {item.reg_qty !== 9999 && <span>{t('stockLeft', { count: item.stock_qty })}</span>}
                </div>
              </div>
            </Link>
          ))}
