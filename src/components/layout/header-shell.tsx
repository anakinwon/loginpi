        ...
        className={cn(
          ...
          floating
            ? // Pi Browser: 둥근 플로팅 바 (푸터와 동일 스타일: muted→border 그라데이션 + 3D 볼륨 섀도)
              ...
              'bg-muted from-muted fixed inset-x-3 rounded-2xl border bg-gradient-to-b to-[var(--color-border)] shadow-[0_14px_34px_-8px_rgba(0,0,0,0.42),inset_0_1px_0_0_rgba(255,255,255,0.25),inset_0_-2px_3px_-1px_rgba(0,0,0,0.16)]'
