      ...
      >
        ...
        >
          ...
          <div className='mb-5 space-y-2.5 rounded-xl bg-muted/50 p-4 text-xs text-muted-foreground'>
            <PolicyItem>
              구독 취소 시 <strong className='text-foreground'>즉시 환불이 없습니다.</strong> 이미
              결제된 기간은 만료일까지 정상 이용할 수 있습니다.
            </PolicyItem>
            <PolicyItem>
              취소는 자동 갱신을 중단하는 방식입니다. 현재 구독 기간 종료 후 자동으로 갱신되지
              않습니다.
            </PolicyItem>
            <PolicyItem>결제 실패 시 자동 갱신이 자동으로 중단됩니다.</PolicyItem>
