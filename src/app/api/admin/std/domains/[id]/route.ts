...
export async function PATCH(
  ...
  if (body.key_dom_phy_nm !== undefined)
    patch.key_dom_phy_nm = body.key_dom_phy_nm.trim().toUpperCase()
  ...
  if (body.dom_desc !== undefined)
    patch.dom_desc = body.dom_desc?.trim() || null
