...
export async function PATCH(req: NextRequest, { params }: { params: Promise<{ id: string }> }) {
  ...
  if (body.dic_phy_nm !== undefined) patch.dic_phy_nm = body.dic_phy_nm.trim().toUpperCase()
  if (body.dic_phy_fll_nm !== undefined) patch.dic_phy_fll_nm = body.dic_phy_fll_nm?.trim().toUpperCase() || null
  if (body.dic_desc !== undefined) patch.dic_desc = body.dic_desc?.trim() || null
