...
export async function GET(request: NextRequest) {
  ...
  type ShopRow = {
    shop_id: string; shop_nm: string; shop_type_cd: string | null
    addr: string | null; contact_tel: string | null; biz_hour: string | null
    lat: number; lng: number; place_id: string | null
  }
