...
export const STORE_ERRORS = {
  ...
  STORE_LBS_CONSENT_REQUIRED:
    '위치기반서비스 동의가 필요합니다 (현장 위치 확인)',
  STORE_CLAIM_FIELDS_REQUIRED:
    '매장명·전화번호·대표자명·주소·이메일을 모두 입력해주세요',
  STORE_PLACE_ID_MISMATCH:
    'place_id가 정확히 일치하지 않습니다 (대소문자 구분)',
  ...
  STORE_PHONE_MISMATCH:
    '입력한 전화번호가 구글에 등록된 매장 전화번호와 다릅니다',
  ...
  STORE_SHOP_NOT_OWNED_OR_MISSING:
    '본인 매장이 아니거나 존재하지 않는 매장입니다',
  ...
  // 매장 관리직원 (mps_shop_staff)
  STORE_STAFF_USER_NOT_FOUND:
    '해당 Pi username의 사용자를 찾을 수 없습니다 (앱 가입자만 등록 가능)',
  STORE_STAFF_IS_OWNER: '매장 소유자는 직원으로 등록할 필요가 없습니다',
  STORE_STAFF_ALREADY: '이미 등록된 직원입니다',
  STORE_STAFF_ADD_FAILED: '직원 등록에 실패했습니다',

  // 주문 조회·상태 전이
  STORE_ORDER_NOT_PARTY: '주문 당사자만 조회할 수 있습니다',
  STORE_ACCEPT_NOT_ALLOWED:
    '접수할 수 없습니다 (상품주문중인 본인 매장 주문만 가능)',
  STORE_COMPLETE_NOT_ALLOWED:
    '거래 완료 처리할 수 없습니다 (구매자 수령 확인 후 본인 판매 주문만 가능)',
  STORE_PICKUP_NOT_ALLOWED:
    '픽업 처리할 수 없습니다 (상품준비완료된 본인 주문만 가능)',
  ...
  FBCK_SHOP_NOT_PARTICIPATING:
    '이 매장은 이용후기·보상 프로그램에 참여하지 않습니다',
  ...
  FBCK_BOND_SHOP_REQUIRED: '보증금을 관리할 매장을 지정해야 합니다',
