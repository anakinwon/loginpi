...
|---|---|
| **PyChat (Cafés)** | Theme-based real-time communities for Pi users who share interests |
| **PyShop™ (Marketplace)** | Pi-settled P2P trading plus O2O offline-store commerce |
| **PyVoice (Voice Chat)** | WebRTC-based N:N voice channels |
...
- ✅ **Access**: use of and discounts on café/marketplace/voice features · **global real-time translation (PyTranslate™)** · **payment of marketplace buy/sell fees**
...
| 4 | **Global translation (PyTranslate™)** | Pay for real-time translation usage |
| 5 | **Marketplace fees** | Pay PyShop™ buy/sell fees in BEAN |
