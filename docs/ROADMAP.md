...
| 24 | 메인넷 전환 & 2단계 배포 인프라 | 🔶 등재 준비 가속 | 컷오버·PI모드·sandbox=false·결제 전 흐름 실기기 검증 완료 + **절제 오버레이 운영 적용·검증(C-1-F-① 완결, sql/172)·등재 체크리스트 listing prep/live(sql/169·172)·방침 A-7 입증 체인 완결(2026-07-09)**. 잔여: Dev Portal·도메인검증·등재 신청 (MAINNET_READINESS_CHECKLIST) |
