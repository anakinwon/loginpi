...
| 상품 구독료(PiCafe·PiShop S/M/L·자동번역) | 1,000~50,000 | `bean_subscr` | `api/subscriptions/products/subscribe`→`fn_bean_subscribe_product` | ✅ 배포(실사용 0) | ✅ 잔액만 있으면 |
...
|---|---|
| 구독자 | 사용자 ID / 별명 |
| 상품 | PiCafe Basic / Premium / PiShop Pro / ... |
