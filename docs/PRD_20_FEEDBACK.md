...
### 1-1. 목적
- **PyCafé™ 카페 이용 후기** — 채팅방 참여 후 별점·본문·이미지로 후기 작성
- **PyShop™ 상품 구매 후기** — 주문 완료 후 별점·본문·이미지로 후기 작성
...
### 14-4. 브랜드 표기
- CLAUDE.md § 공식 브랜드 표기 — PyCafé™, PyShop™, BeanIcon
- Bean 호칭: "카페빈" (일반 콩 아님)
