...
| 구매자 취소 | 0π | 환불액에서 공제 (징수 보장 — 에스크로 보관 중) | 구매자 | **판매자** (기회비용 보상) |
| 판매자 취소 | 0π | 후불 정산 차감 또는 보증금 공제 (→ §12 #1) | 판매자 | **구매자** (대기시간 보상) |
| 관리자 강제 취소 | 0π | 0π | 없음 | 없음 (분쟁 처리) |

> ⚠️ 정식 수수료율·판매자 징수 방식 미결 → §12 Open Issues #1 참조
...
| # | 미결 사항 | 우선순위 | 담당 |
|---|-----------|---------|------|
| 1 | **수수료율·판매자 징수 방식 결정** — ~~정책 방향~~ v1.4 확정: 베타 0π·귀속처는 피해 상대방. **잔여**: 정식 도입 시점의 수수료율(%)·상하한 캡, 판매자 취소 징수 방식(후불 정산 차감 vs PiRC3 보증금) 택일 | 높음 | 비즈니스 |
