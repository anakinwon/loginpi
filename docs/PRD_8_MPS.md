...
- ⚠️ 산식 주석: 9회 × 0.1π = 0.9π 공제 기준이며, 잔여 0.1π의 처리(반환 송금 수수료 충당 vs 10회째 일부 충당)는
  §12 미결 #1에서 확정한다.
...
| # | 미결 사항 | 우선순위 | 담당 |
|---|-----------|---------|------|
| 1 | **수수료 정책** — v1.4~1.6 확정: 베타 0π·귀속처 피해 상대방·보증금 연동 단서·**취소수수료 정액 0.1π·보증금 1π(누적 9회)**. **잔여**: ① 정상 거래 완료 수수료율(TBD %) ② 보증금 잔여 0.1π 처리(9회×0.1π=0.9π — 반환 송금 수수료 충당 vs 10회째 일부 충당) | 중간 | 비즈니스 |
