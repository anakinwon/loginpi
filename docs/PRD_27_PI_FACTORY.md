...
| sitemap.pi | SITEMAP | **HUB(전용)** | ⭐**통합 관리 허브** (2026-07-09 마스터 확정) — 네트워크 디렉토리·내 사이트 대시보드·페르소나 일괄 관리·통합 자산 뷰·공식 고지 정본 (§2.6) | **W2 (승격)** |
...
- **웨이브 조정**: sitemap.pi W4 → **W2 승격** — 통합 관리는 사이트가 2개 이상 되는 순간(yea.pi 오픈 직후)부터 필요.
