...
| `ROADMAP.md` | 개발 마일스톤 **라이트버전** — 진행률 1줄 표·재사용 가이드 (TASK 상세 원문: `archive/ROADMAP_FULL_v12.10_2026-07-08.md`) |
...
- `archive/` — 완료된 일회성 점검 결과 + 라이트 개편 전 원문 보관: `PRD_FULL_v12.8_2026-07-08.md`(구 PRD.md — Phase 구현 상세·디렉토리 구조·전체 변경이력) · `ROADMAP_FULL_v12.10_2026-07-08.md`(구 ROADMAP.md — TASK 단위 상세·마일스톤 M0~M31·전체 변경이력)
