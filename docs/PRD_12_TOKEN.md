...
> **작성일**: 2026-06-17
> **버전**: v1.8
> **상태**: T01 KYC 임시승인 단계 · T02 공식창구=in-app Launchpad(Mainnet 미출시, ~6/28 Testnet) · T05 법무 지연 가능(Mainnet 세일 전 필수) · 법무 의뢰서 단독 문서 작성 완료
...
- **1차 목적 = 유틸리티 토큰(Utility Token)**: BEAN은 cafe.pi 생태계 내 **사용권·보상·결제 수단**으로 규정.
  - 기존 인앱 "Pi Bean" 팁의 온체인화 (사용자 간 후원)
  - 미션·이벤트 보상, 카페/MPS/보이스챗 기능 이용·할인
  - 향후 거버넌스 투표권(수익권과 **분리**)
