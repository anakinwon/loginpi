...
| 축 | 현행(파기) | 신규(본 설계) |
|---|---|---|
| 단위 | 사용자 등급 1개 (Explorer/Creator/Host) | **상품군별 독립 구독** (PiCafe·PiShop·자동번역), 동시 다중 |
...
| 🏪 PiShop 구독 | S (상품 30개↓) | 3,000 / 30π | 30,000 | 노출·생성 건당요금 면제 |
| 🏪 PiShop 구독 | M (상품 50개↓) | 4,000 / 40π | 40,000 | |
| 🏪 PiShop 구독 | L (상품 50개↑) | 5,000 / 50π | 50,000 | |
