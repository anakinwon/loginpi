-- sql/main/sql1_ops_checklist_prod_cutover.sql
-- ⭐ 운영DB(Product_CafePi · ajdwlcqoljkjamostutc) 적용 전용.
--   ▸ staging(dev) 동일본 = sql/137_ops_checklist_prod_cutover.sql (루트). 내용·결과 동일(멱등).
...
-- 내용: Open Beta 체크리스트(ops_checklist) 섹션0 운영DB 컷오버 진척 현행화 (2026-06-29)
